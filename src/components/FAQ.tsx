 ...
 const faqItems = [
   ...
   {
     question: "В каком формате нужен материал?",
     answer:
       "Предпочтительно EXR или DPX для работы с максимальным качеством. Также принимаю ProRes, DNxHR и другие профессиональные кодеки. MP4/H.264 — только для тестов.",
   },
 ];
