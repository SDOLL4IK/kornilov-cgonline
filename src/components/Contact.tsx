      ...
      <div className="container max-w-3xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 md:gap-4">
          {contacts.map((contact) => {
            const content = (
              <div className="p-4 md:p-6 rounded-xl bg-secondary border border-border hover:border-primary/50 transition-colors duration-300 text-center h-full flex sm:flex-col items-center sm:items-center gap-4 sm:gap-0">
